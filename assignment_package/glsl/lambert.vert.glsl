...
uniform vec3 u_Sun;         // The sun center used to calculate the light direction
...
void main()
{
    ...
    fs_LightVec = normalize(vec4(u_Sun - modelposition.xyz, 0));
