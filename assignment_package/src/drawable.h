...
protected:
    ...
    int m_count_trans; // The number of indices stored in bufIdxTrans.
    ...
    GLuint m_bufInter; // A Vertex Buffer Object
    GLuint m_bufInterTrans;
